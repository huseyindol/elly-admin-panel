  ...
  return (
    ...
    >
      ...
      <PlaybackBar
        ...
        duration={duration}
        playing={playing}
        onPlayPause={() => setPlaying((p: any) => !p)}
        onReset={() => {
          setTime(0)
        }}
        onSeek={(t: any) => setTime(t)}
        onHover={(t: any) => setHoverTime(t)}
      />
    </div>
  )
}
  ...
  return (
    <>
      <Sprite start={0} end={3}>
        ...
        />
        <TextSprite
          text="Re-usable animation component"
          x="50%"
          y="55%"
          align="center"
          size={24}
      ...
      <Sprite start={2.5} end={6}>
        <RectSprite x="30%" y="40%" width={120} height={120} color="#ff6b6b" />
        <RectSprite
          x="50%"
          y="40%"
          width={120}
      ...
      <Sprite start={5.5} end={10}>
        <TextSprite
          text="Now running as a Next.js Page!"
          x="50%"
          y="50%"
          align="center"
          size={48}
